...
namespace xpdraw {
    ...
    void drawRectBorder(int left, int bottom, int width, int height, int borderSize, xpdraw::color color = { 1, 1, 1, 1 }, xpdraw::color borderColor = { 1, 1, 1, 1 });
    ...
    void drawLine(int start_x, int start_y, int end_x, int end_y, int thickness, xpdraw::color color = { 1, 1, 1, 1 });
